# Refer to https://github.com/WxxShirley/LLMNodeBed/blob/main/common/dataloader.py
import torch
import os
import json
...
def load_graph_dataset(dataset_name, device, re_split=False, path_prefix="../.."):
    graph_data = torch.load(f"{path_prefix}/datasets/{dataset_name}.pt", weights_only=False, map_location='cpu').to(device)
    # Alternative 
