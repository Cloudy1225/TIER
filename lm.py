...
class TextEncoder(nn.Module):
    ...
    def engine_forward(self, all_text, max_length=512, pool="cls"):
        ...
        with torch.no_grad():
            for input_text in tqdm(all_text, desc="Preparing All Hidden States"):
                ...
                encoded_input = self.tokenizer(input_text, return_tensors='pt', padding=True, truncation=True,
    ...
    def forward(self, input_text, pooling="cls", max_length=512):
        ...
        if self.encoder_type == "LM":
            ...
            encoded_input = self.tokenizer(input_text, add_special_tokens=False, return_tensors="pt", padding=True,
